	...
	<div class="portlet box  ">
		...
		<div class="portlet-body  ">
				...
				<ul class="nav nav-tabs">
					...
					<li class="active" ><a   href="memberMar2.jsp">积分兑换</a></li>
				...
				<div class="row">
					 	...
					 	<div id="add-card" class="col-md-6">
					 		<span class="fa fa-plus"></span> 新增积分兑换活动
					 	</div>
...
<script type="tpl" id="add-card-tpl">
	...
	<div class="form-horizontal">
		<div class="form-body">
			...
			<div class="form-group">
				<label  class="col-md-3 col-md-offset-1 ">设置兑换积分</label>
				<div class="col-md-8">
					<input name="number" type="text" class="form-control"  placeholder=""> 
				</div>
			</div>
			...
			<div class="form-group">
				<label  class="col-md-3 col-md-offset-1 ">每人可兑换次数</label>
				<div class="col-md-8">
					<input name="number" type="text" class="form-control"  placeholder=""> 
				</div>
			</div>
