	...
	<div class="portlet box  ">
		...
		<div class="portlet-body  ">
				...
				<ul class="nav nav-tabs">
					...
					<li class="active"><a   href="memberMar4.jsp">用户唤醒</a></li>
				</ul>

				<div class="row">
					 	
					 	<div id="add-card" class="col-md-6">
					 		<span class="fa fa-plus"></span> 新增用户唤醒活动
					 	</div>
...
<script type="tpl" id="add-card-tpl">
	...
	<div class="form-horizontal">
		<div class="form-body">
			...
			<div class="form-group">
				<label  class="col-md-3 col-md-offset-1 ">设置沉睡用户定义：</label>
				<div class="col-md-8">
					<input name="number" type="text" class="form-control"  placeholder=""> 
					天 未到店消费
				</div>
		...
		var $dialog = null;
			...
			setTimeout(function(){
				...
				$("#add-card").click(function(){
					...
					$dialog = showModal_2('#msg','新增用户唤醒活动'
						,$("#add-card-tpl").html());
				})
			},100)
</script>
