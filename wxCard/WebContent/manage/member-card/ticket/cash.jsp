                        ...
                        <div class="editor_section">
                            ...
                            <div class="appmsg_edit_item frm_normal upload_item">
                                ...
                                <span class="appmsg_preview_msg">
                                    ...
                                    <input type="hidden" name="logo_url" value="/manage/ticket/img/券.jpg">
<%--                                     <p class="frm_tips"> --%>
<!--                                         如商户信息有变更，请在 -->
...
<%--                                     </p> --%>
                            ...
                            <div class="appmsg_edit_item frm_normal">
                                ...
                                <span class="frm_input_box">
                                    <input value="" name="reduce_cost" type="text" target="#js_title_tip" data-maxlength="9"
                                ...
                                <p id="reduce_costErrorMsg" class="frm_msg fail" style="display: none;">
                            ...
                            <div class="appmsg_edit_item frm_normal">
                                ...
                                <p class="frm_tips">
                                    建议填写代金券“减免金额”及自定义内容，描述卡券提供的具体优惠
                                </p>
                            </div>
                            ...
                            <div class="appmsg_edit_item appmsg_input_submsg_item group appmsg_edit_item_label_mult">
							    ...
							    <div class="input_submsg group">
							        <span class="frm_input_box">
							            <input value="" id="js_least_cost" name="least_cost" type="text" class="frm_input valid"
							            placeholder="">
							        </span>
							        <span>
							            元
...
<!--                                         </div> -->
                                        <div class="radio_control_group group">
                                            <label radio class="frm_radio_label" for="checkbox5">
                                                ...
                                                <input checked="true"  data-key="1"  type="radio" name="code_type"  value="CODE_TYPE_BARCODE" class="frm_radio" id="checkbox5">
                                                <p class="frm_tips">
                                                    包含卡券信息的条形码，扫描后可进行销券
                                                </p>
                                            </label>
...
<script>
var create_action ="${p:go('','createTicketAction','') }&card_type=CASH";
Common.init();
</script>
<script type="text/javascript" src="js/moment.min.js"></script>
<script type="text/javascript" src="js/daterangepicker.js"></script>
<script src="js/cash.js?R=3"></script> 
