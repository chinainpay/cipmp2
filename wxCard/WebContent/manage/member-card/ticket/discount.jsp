...
<%--                                     </p> --%>
                            ...
                            <div class="appmsg_edit_item">
                                ...
                                <div class="input_submsg">
                                    <span class="frm_input_box">
                                        <input value="" id="js_discount" name="discount" type="text" class="frm_input frm_msg_content"
                                        placeholder="">
                                    </span>
                                ...
                                <p id="discountErrorMsg" class="frm_msg fail" style="display: none;">
                                    <span for="js_discount" class="frm_msg_content"    >
                                        折扣额度只能是大于0.1且小于10的数字
                                    </span>
                                </p>
                            </div>
                            <div class="appmsg_edit_item frm_normal">
                                ...
                                <p class="frm_tips">
                                    建议填写折扣券“折扣额度”及自定义内容，描述卡券提供的具体优惠
                                </p>
                            </div>
...
<script>
var create_action ="${p:go('','createTicketAction','') }&card_type=DISCOUNT";
Common.init();
</script>
<script type="text/javascript" src="js/moment.min.js"></script>
<script type="text/javascript" src="js/daterangepicker.js"></script>
<script src="js/discount.js?R=2"></script>
