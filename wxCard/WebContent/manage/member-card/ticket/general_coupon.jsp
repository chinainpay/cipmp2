...
<!--                                         </div> -->
                                        <div class="radio_control_group group">
                                            <label radio class="frm_radio_label" for="checkbox5">
                                                ...
                                                <input checked data-key="1"  type="radio" name="code_type"  value="CODE_TYPE_BARCODE" class="frm_radio" id="checkbox5">
                                                <p class="frm_tips">
                                                    包含卡券信息的条形码，扫描后可进行销券
                                                </p>
                                            </label>
                            ...
                            <div class="appmsg_edit_item textarea_item">
                                ...
                                <div class="frm_controls">
                                    <div class="frm_textarea_box">
                                        <textarea class="frm_textarea" name="detail" placeholder=""></textarea>
                                    </div>
                                </div>
                                <p id="detailErrorMsg" class="frm_msg fail" style="display: none;">
...
<script>
var create_action ="${p:go('','createTicketAction','') }&card_type=GENERAL_COUPON";
Common.init();
</script>
<script type="text/javascript" src="js/moment.min.js"></script>
<script type="text/javascript" src="js/daterangepicker.js"></script>
<script src="js/general_coupon.js?R=2"></script>
