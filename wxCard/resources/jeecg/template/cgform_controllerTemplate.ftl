...
import com.chinainpay.tag.core.common.controller.BaseController;
import com.chinainpay.tag.core.common.exception.BusinessException;
import com.chinainpay.tag.core.common.hibernate.qbc.CriteriaQuery;
import com.chinainpay.tag.core.common.model.json.AjaxJson;
import com.chinainpay.tag.core.common.model.json.DataGrid;
import com.chinainpay.tag.core.constant.Globals;
import com.chinainpay.tag.core.util.StringUtil;
import com.chinainpay.tag.core.easyui.TagUtil;
import com.chinainpay.web.system.pojo.base.TSDepart;
import com.chinainpay.web.system.service.SystemService;
import com.chinainpay.tag.core.util.MyBeanUtils;

import java.io.OutputStream;
import com.chinainpay.tag.core.util.BrowserUtils;
...
import com.chinainpay.tag.core.util.ResourceUtil;
import java.io.IOException;
import org.springframework.web.bind.annotation.RequestMethod;
import org.springframework.web.multipart.MultipartFile;
import org.springframework.web.multipart.MultipartHttpServletRequest;
import java.util.Map;
import com.chinainpay.tag.core.util.ExceptionUtil;
...
public class ${entityName}Controller extends BaseController {
	...
	public void datagrid(${entityName}Entity ${entityName?uncap_first},HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		com.chinainpay.tag.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, ${entityName?uncap_first}, request.getParameterMap());
		try{
		//自定义追加查询条件
		<#list columns as po>
