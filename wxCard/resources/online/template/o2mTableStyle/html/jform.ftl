						...
						<#elseif po.show_type=='file'>
								<table>
									<#list imageList as imageB>
										...
										<td>${imageB['title']}</td>
										<td><a href="commonController.do?viewFile&fileid=${fileB['fileKey']}&subclassname=com.chinainpay.web.cgform.entity.upload.CgUploadEntity" title="下载">下载</a></td>
										<td><a href="javascript:void(0);" onclick="openwindow('预览','commonController.do?openViewFile&fileid=${fileB['fileKey']}&subclassname=com.chinainpay.web.cgform.entity.upload.CgUploadEntity','fList',700,500)">预览</a></td>
